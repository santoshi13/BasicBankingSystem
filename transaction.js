 ...
 var enterSName = document.getElementById("enterName").value;
  var findSenderBankAccount = enterSName + "BankBalance";
    ...
    if (enterAmount > enterSAmount) {
       ...
       var textNode = document.createTextNode(`Rs ${enterAmount} is sent from the sender with E-mail Id ${enterSName}@gmail.com
  to recepient with E-mail Id ${enterName}@gmail.com on ${Date()}.`);
